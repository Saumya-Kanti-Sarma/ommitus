...
export default function Login() {
  ...
  const handleTogglePassword = () => showPassword ? setShowPassword(false) : setShowPassword(true)
  return (
    <main className="flex h-[100dvh] w-[100vw] max-2xl:flex-col">
      ...
      <aside className="flex-1 bg-[var(--blue)] text-white flex flex-col justify-center items-center p-12 space-y-4 max-md:hidden">
        <img src="/logo/ommitus-main-menu.svg" alt="logo.svg" className=" w-[50%] max-w-[200px] " />
      ...
      <div className=" w-full flex-1 flex flex-col justify-center items-center px-2 py-12 max-2xl:flex-5 max-2xl:justify-start max-2xl:py-0">
        ...
        <h1 className=" text-center text-4xl text-[var(--blue)] font-bold my-5 max-md:text-xl">Register Your Restaurant With <b>Ommitus</b></h1>
        <form className="bg-[var(--blue)] shadow-md rounded-xl p-10 space-y-6 w-[98%] max-w-[1000px] max-md:p-5 max-md:space-y-3">
          ...
          <div>
            ...
            <div className="flex items-center border border-[var(--gray)] rounded-md bg-white">
              ...
              />
              <button type="button" className="p-2 cursor-pointer" onClick={handleTogglePassword}>
                <img src={showPassword ? "/icons/eye.svg" : "/icons/close-eye.svg"} alt="password-icon" className="w-5 h-5" />
              </button>
            </div>
          </div>
          <br />
        ...
        <button className="w-[96%] max-w-[1000px] p-4 rounded-2xl bg-[var(--blue)] text-white mt-10 text-2xl font-medium">Watch a tutorial</button>
      </div>
    </main>
  );
}
